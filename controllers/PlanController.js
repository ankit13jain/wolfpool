    ...
    if (err) {
      ...
      var mj_req = mailjet
        ...
        .request({
          ...
          "Html-part": 'Hi there! ' + request.session.userName + ' just joined your trip with details listed below. Following are the email addresses of everyone in the plan: ' + emails_for_mail + '.<br/><h4>Trip details:<h4/><br/>Source: ' + plan.source_id + '<br/>Destination: ' + plan.destination_id + '<br/>Date: ' + plan.date + '<br/>Time: ' + plan.time,
          "Recipients": emails
        });
